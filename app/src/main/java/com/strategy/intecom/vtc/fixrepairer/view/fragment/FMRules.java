...
public class FMRules extends AppCore implements SwipeRefreshLayout.OnRefreshListener {
    ...
    @SuppressLint("ValidFragment")
    public FMRules(Callback callback) {
    ...
    public void onResume() {
        super.onResume();
//        AppCore.initSettitle(Const.TYPE_MENU_NOMAL, getResources().getString(R.string.title_rules));
    }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            return inflater.inflate(R.layout.ui_rules, container,
                    false);
        }
        ...
        public void onViewCreated(final View view, Bundle savedInstanceState) {
            ...
            tv_title.setText(getResources().getString(R.string.title_rules));
