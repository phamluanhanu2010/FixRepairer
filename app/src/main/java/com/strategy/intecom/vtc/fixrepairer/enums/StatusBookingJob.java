...
//    private final String STATUS_CANCEL = "Agency cancel";
//    private final String STATUS_EXPRIED = "Expried";
    ...
    public static StatusBookingJob fromString(String text) {
        if (text != null) {
            for (StatusBookingJob b : StatusBookingJob.values()) {
