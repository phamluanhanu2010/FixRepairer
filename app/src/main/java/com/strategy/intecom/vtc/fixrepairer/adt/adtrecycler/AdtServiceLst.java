 ...
 */
public class AdtServiceLst extends RecyclerView.Adapter<AdtServiceLst.ViewHolder> {
    ...
    public AdtServiceLst() {
    }

    // Create new views (invoked by the layout manager)
    @Override
    public AdtServiceLst.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                   int viewType) {
        // create a new view
